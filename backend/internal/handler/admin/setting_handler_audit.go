...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.RechargeStorefrontEnabled != after.RechargeStorefrontEnabled {
		changed = append(changed, service.SettingKeyRechargeStorefrontEnabled)
	}
	if before.RechargeStorefrontButtonText != after.RechargeStorefrontButtonText {
		changed = append(changed, service.SettingKeyRechargeStorefrontText)
	}
	if before.RechargeStorefrontURL != after.RechargeStorefrontURL {
		changed = append(changed, service.SettingKeyRechargeStorefrontURL)
	}
	...
	if before.SupportGroupButtonText != after.SupportGroupButtonText {
		changed = append(changed, service.SettingKeySupportGroupButtonText)
	}
	if before.SupportGroupTitle != after.SupportGroupTitle {
		changed = append(changed, service.SettingKeySupportGroupTitle)
	}
	if before.SupportGroupDescription != after.SupportGroupDescription {
		changed = append(changed, service.SettingKeySupportGroupDescription)
	}
	if before.SupportGroupQRCodeURL != after.SupportGroupQRCodeURL {
		changed = append(changed, service.SettingKeySupportGroupQRCodeURL)
	}
	if before.SupportGroupLinkURL != after.SupportGroupLinkURL {
		changed = append(changed, service.SettingKeySupportGroupLinkURL)
	}
	if before.SupportTicketsEnabled != after.SupportTicketsEnabled {
		changed = append(changed, service.SettingKeySupportTicketsEnabled)
	}
	if before.PixmoStudioEnabled != after.PixmoStudioEnabled {
		changed = append(changed, service.SettingKeyPixmoStudioEnabled)
	}
	if before.PixmoStudioButtonText != after.PixmoStudioButtonText {
		changed = append(changed, service.SettingKeyPixmoStudioButtonText)
	}
	if before.PixmoStudioURL != after.PixmoStudioURL {
		changed = append(changed, service.SettingKeyPixmoStudioURL)
	}
	if before.UsageHelpEnabled != after.UsageHelpEnabled {
		changed = append(changed, service.SettingKeyUsageHelpEnabled)
	}
	if before.ModelRadarEnabled != after.ModelRadarEnabled {
		changed = append(changed, service.SettingKeyModelRadarEnabled)
	}
	if before.AcquisitionEnabled != after.AcquisitionEnabled {
		changed = append(changed, service.SettingKeyAcquisitionEnabled)
	}
	if before.AcquisitionLeaderboardEnabled != after.AcquisitionLeaderboardEnabled {
		changed = append(changed, service.SettingKeyAcquisitionLeaderboardEnabled)
	}
	if before.AcquisitionLotteryEnabled != after.AcquisitionLotteryEnabled {
		changed = append(changed, service.SettingKeyAcquisitionLotteryEnabled)
	}
	...
	if before.UsageRebateEnabled != after.UsageRebateEnabled {
		changed = append(changed, service.SettingKeyUsageRebateEnabled)
	}

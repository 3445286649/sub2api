...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		SupportTicketsEnabled:                  req.SupportTicketsEnabled,
		...
		AcquisitionLeaderboardEnabled:          req.AcquisitionLeaderboardEnabled,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRechargeMultiplier != nil || req.PaymentBalanceRechargeBonusDisplayEnabled != nil ||
		req.PaymentBalanceRechargeBonusEnabled != nil || req.PaymentBalanceRechargeBonusThreshold != nil ||
		req.PaymentBalanceRechargeBonusPercent != nil || req.PaymentSubscriptionUSDToCNYRate != nil ||

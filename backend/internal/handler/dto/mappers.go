...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		HealthProbeWhenUnschedulable: a.HealthProbeWhenUnschedulable(),
		...
		HealthyProbeIntervalMinutes: a.HealthyProbeIntervalMinutes,
		...
		ExternalSchedulingHoldUntil: a.ExternalSchedulingHoldUntil,

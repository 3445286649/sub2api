...
type CreatePlanRequest struct {
	...
	QuotaResetScope string   `json:"quota_reset_scope"`
	QuotaResetValue float64  `json:"quota_reset_value"`
...
func (s *PaymentConfigService) UpdatePaymentConfig(ctx context.Context, req UpdatePaymentConfigRequest) error {
	...
	if req.BalanceRechargeBonusDisplayEnabled != nil {
		m[SettingBalanceRechargeBonusDisplay] = formatBoolOrEmpty(req.BalanceRechargeBonusDisplayEnabled)
	}
	if req.BalanceRechargeBonusEnabled != nil {
		m[SettingBalanceRechargeBonusEnabled] = formatBoolOrEmpty(req.BalanceRechargeBonusEnabled)
	}
	if req.BalanceRechargeBonusThreshold != nil {
		m[SettingBalanceRechargeBonusThreshold] = formatPositiveFloatExact(req.BalanceRechargeBonusThreshold)
	}
	if req.BalanceRechargeBonusPercent != nil {
		m[SettingBalanceRechargeBonusPercent] = formatPositiveFloatExact(req.BalanceRechargeBonusPercent)
	}

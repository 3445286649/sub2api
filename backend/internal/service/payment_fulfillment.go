...
func (s *PaymentService) doSub(ctx context.Context, o *dbent.PaymentOrder, lease *paymentFulfillmentLease) error {
	if normalizeSubscriptionPlanType(o.SubscriptionPlanType) == SubscriptionPlanTypeQuotaReset {
		return s.doQuotaResetSub(ctx, o, lease)
	}
...
func (s *PaymentService) doQuotaResetSub(ctx context.Context, o *dbent.PaymentOrder, lease *paymentFulfillmentLease) error {
	gid := *o.SubscriptionGroupID

...
// QueryAssignedAdmin queries the assigned_admin edge of a SupportTicket.
func (c *SupportTicketClient) QueryAssignedAdmin(_m *SupportTicket) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryClosedByUser queries the closed_by_user edge of a SupportTicket.
func (c *SupportTicketClient) QueryClosedByUser(_m *SupportTicket) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QuerySender queries the sender edge of a SupportTicketMessage.
func (c *SupportTicketMessageClient) QuerySender(_m *SupportTicketMessage) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(supportticketmessage.Table, supportticketmessage.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, supportticketmessage.SenderTable, supportticketmessage.SenderColumn),
		)
		fromV = sqlgraph.Neighbors(_m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryAssignedSupportTickets queries the assigned_support_tickets edge of a User.
func (c *UserClient) QueryAssignedSupportTickets(_m *User) *SupportTicketQuery {
	query := (&SupportTicketClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryClosedSupportTickets queries the closed_support_tickets edge of a User.
func (c *UserClient) QueryClosedSupportTickets(_m *User) *SupportTicketQuery {
	query := (&SupportTicketClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QuerySupportTicketMessages queries the support_ticket_messages edge of a User.
func (c *UserClient) QuerySupportTicketMessages(_m *User) *SupportTicketMessageQuery {
	query := (&SupportTicketMessageClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(

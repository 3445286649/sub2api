...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "health_probe_enabled", Type: field.TypeBool, Default: true},
		{Name: "health_probe_interval_minutes", Type: field.TypeInt, Nullable: true},
		{Name: "health_probe_model", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "healthy_probe_enabled", Type: field.TypeBool, Default: false},
		{Name: "healthy_probe_interval_minutes", Type: field.TypeInt, Nullable: true},
		{Name: "healthy_probe_interval_hours", Type: field.TypeInt, Nullable: true},
		...
		{Name: "external_scheduling_hold_until", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	ChannelMonitorHistoriesColumns = []*schema.Column{
		...
		{Name: "failure_category", Type: field.TypeString, Size: 40, Default: "none"},
		{Name: "http_status", Type: field.TypeInt, Nullable: true},
		{Name: "request_path", Type: field.TypeString, Size: 120, Default: ""},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorHistoriesColumns[11], ChannelMonitorHistoriesColumns[1], ChannelMonitorHistoriesColumns[10]},
			},
			{
			...
			{
				Name:    "channelmonitorhistory_failure_category",
				Unique:  false,
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "subscription_plan_type", Type: field.TypeString, Size: 30, Default: "subscription"},
		{Name: "quota_reset_scope", Type: field.TypeString, Size: 20, Default: ""},
		{Name: "quota_reset_value", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
	...
	// RedeemCampaignsColumns holds the columns for the "redeem_campaigns" table.
	RedeemCampaignsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
	...
	// RedeemCampaignsTable holds the schema information for the "redeem_campaigns" table.
	RedeemCampaignsTable = &schema.Table{
		Name:       "redeem_campaigns",
		Columns:    RedeemCampaignsColumns,
		PrimaryKey: []*schema.Column{RedeemCampaignsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "redeemcampaign_status",
				Unique:  false,
				Columns: []*schema.Column{RedeemCampaignsColumns[2]},
			},
			{
				Name:    "redeemcampaign_expires_at",
				Unique:  false,
				Columns: []*schema.Column{RedeemCampaignsColumns[4]},
			},
		},
	}
	// RedeemCampaignRedemptionsColumns holds the columns for the "redeem_campaign_redemptions" table.
	RedeemCampaignRedemptionsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "campaign_id", Type: field.TypeInt64},
		{Name: "user_id", Type: field.TypeInt64},
		{Name: "redeem_code_id", Type: field.TypeInt64, Nullable: true},
		{Name: "redeemed_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// RedeemCampaignRedemptionsTable holds the schema information for the "redeem_campaign_redemptions" table.
	RedeemCampaignRedemptionsTable = &schema.Table{
		Name:       "redeem_campaign_redemptions",
		Columns:    RedeemCampaignRedemptionsColumns,
		PrimaryKey: []*schema.Column{RedeemCampaignRedemptionsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "redeemcampaignredemption_campaign_id_user_id",
				Unique:  true,
				Columns: []*schema.Column{RedeemCampaignRedemptionsColumns[1], RedeemCampaignRedemptionsColumns[2]},
			},
			{
				Name:    "redeemcampaignredemption_redeem_code_id",
				Unique:  true,
				Columns: []*schema.Column{RedeemCampaignRedemptionsColumns[3]},
			},
			{
				Name:    "redeemcampaignredemption_user_id",
				Unique:  false,
				Columns: []*schema.Column{RedeemCampaignRedemptionsColumns[2]},
			},
		},
	}
	...
	RedeemCodesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "code", Type: field.TypeString, Unique: true, Size: 32},
		{Name: "type", Type: field.TypeString, Size: 64, Default: "balance"},
		{Name: "value", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "affiliate_rebate_base_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "plan_type", Type: field.TypeString, Size: 30, Default: "subscription"},
	...
	SupportTicketsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{SupportTicketsColumns[13]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "support_tickets_users_assigned_support_tickets",
				Columns:    []*schema.Column{SupportTicketsColumns[14]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "support_tickets_users_closed_support_tickets",
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "supportticket_assigned_admin_id",
				Unique:  false,
				Columns: []*schema.Column{SupportTicketsColumns[14]},
			},
			{
			...
			{
				Name:    "supportticket_last_user_message_at",
				Unique:  false,
				Columns: []*schema.Column{SupportTicketsColumns[6]},
			},
			{
				Name:    "supportticket_last_admin_message_at",
				Unique:  false,
	...
	SupportTicketMessagesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SupportTicketMessagesColumns[4], SupportTicketMessagesColumns[3]},
			},
			{
				Name:    "supportticketmessage_sender_id",
				Unique:  false,
				Columns: []*schema.Column{SupportTicketMessagesColumns[5]},
			},
		},
	...
	Tables = []*schema.Table{
		...
		ProxiesTable,
		RedeemCampaignsTable,
		RedeemCampaignRedemptionsTable,
		RedeemCodesTable,
...
func init() {
	...
	RedeemCampaignsTable.Annotation = &entsql.Annotation{
		Table: "redeem_campaigns",
	}
	RedeemCampaignRedemptionsTable.Annotation = &entsql.Annotation{
	...
	SupportTicketsTable.ForeignKeys[2].RefTable = UsersTable

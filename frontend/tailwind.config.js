...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // 主色调由 CSS 变量驱动：浅色保持 Teal，深色切换为冷蓝。
        primary: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient':
          'radial-gradient(at 40% 20%, rgb(var(--color-primary-500) / 0.12) 0px, transparent 50%), radial-gradient(at 80% 0%, rgba(6, 182, 212, 0.08) 0px, transparent 50%), radial-gradient(at 0% 50%, rgb(var(--color-primary-500) / 0.08) 0px, transparent 50%)'
      },
      animation: {

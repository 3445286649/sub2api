        ...
        >
          ...
          <template #cell-rate_multiplier="{ row }">
            <div class="flex min-w-[104px] flex-col gap-0.5">
              ...
              <span
                v-if="!row.health?.rate_multiplier_configured && (row.rate_multiplier ?? 1) === 1"
...
import type { Account, AccountPlatform, AccountType, Proxy as AccountProxy, AdminGroup, WindowStats, ClaudeModel, AccountHealthOverview, AccountHealthSummary, AccountHealthURLOverview, AccountHealthRisk, AccountHealthEvent, AccountUpstreamBalanceSnapshot, UpstreamBillingProbeSettings, UpstreamBillingProbeSnapshot } from '@/types'

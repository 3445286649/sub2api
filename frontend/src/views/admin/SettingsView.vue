          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              >
                ...
                <div
                  v-if="form.openai_advanced_scheduler_enabled"
                  class="mt-5 flex items-center justify-between border-t border-gray-200 pt-5 dark:border-dark-700"
                >
                <div>
                  <label
                    class="text-sm font-medium text-gray-700 dark:text-gray-300"
            ...
            <div class="space-y-6 p-6">
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <div class="flex items-center justify-between gap-4">
                  <div>
                    <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                      {{ t("admin.settings.site.usageHelp.title") }}
                    </h3>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      {{ t("admin.settings.site.usageHelp.description") }}
                    </p>
                  </div>
                  <Toggle v-model="form.usage_help_enabled" />
                </div>
              </div>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <p class="mt-1.5 text-xs">
              <router-link
                ...
                class="inline-flex items-center gap-1 text-primary-600 hover:underline dark:text-primary-400"
              >
                {{ t('admin.settings.features.supportTickets.configureLink') }}
                <span aria-hidden="true">→</span>
              </router-link>
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              ...
              <Toggle v-model="form.support_tickets_enabled" />
            </div>
          </div>
        </div>
...
const allPaymentTypes = computed(() => [
  ...
  { value: "usdt_bsc", label: t("payment.methods.usdt_bsc") },
]);
...
const providerKeyOptions = computed(() => [
  ...
  { value: "usdt_bsc", label: t("admin.settings.payment.providerUsdtBsc") },
]);

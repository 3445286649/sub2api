    ...
    >
      ...
      >
        ...
        <CodexManifestAccountsField
          ...
          @update:model-value="updateEditCodexManifestConfig"
        />
...
const updateEditCodexManifestConfig = (value: CodexModelsManifestConfig) => {
  Object.assign(editCodexManifestConfig, value);
};

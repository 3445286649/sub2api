...
const emit = defineEmits(['close', 'test', 'stats', 'schedule', 'health-detail', 'health-probe', 'reauth', 'refresh-token', 'recover-state', 'reset-quota', 'set-privacy', 'create-spark-shadow'])
const { t } = useI18n()

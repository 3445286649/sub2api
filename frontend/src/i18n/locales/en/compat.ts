...
export default {
  ...
  "usageRebate": {
    "title": "Usage Rebate",
    "description": "Your rebate progress today and rebate history",
    "enabled": "Active today",
    "disabled": "Currently disabled",
    "settlement": "Next-day settlement",
    "participants": "Participants today",
    "leaderboard": "Today's spending ranking",
    "progress": "Today's rebate progress",
    ...
    "gapToPrevious": "Spending gap to the previous rank",
    "gapToTop20": "{amount} behind rank 20",
    "top20Hint": "Reach the top 20 to qualify for a rebate",
    "leadingHint": "You are currently first and qualify for the highest rebate rate",
    "eligibleHint": "You are in the top 20; the estimated rebate will be credited after next-day settlement",
    "reward": "Rebate",
    "status": "Status",
    "date": "Date",

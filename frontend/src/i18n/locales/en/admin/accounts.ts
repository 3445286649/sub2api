export default {
    accounts: {
      ...
      probeDetail: 'Account Probe Detail',
      probeDetailLoadFailed: 'Failed to load account probe detail',
      probeNoData: 'No data',
      probeNormal: 'Normal',
      probeAbnormal: 'Abnormal',
      probeSuccessRate: 'Success Rate',
      probeLastResult: 'Latest Result',
      probeLatencyTrend: 'Probe Latency Trend',
      probeFailures: 'Failures',
      nextProbe: 'Next Probe',
      probeEvents: 'Probe Events',
      probeEvents24h: 'Probe Events in the Last 24 Hours',
      cacheRateOneHour: 'Cache Rate, Last Hour',
      cacheRateSample: '{count} requests',
      ...
      healthProbeModelHint: 'Model used for probing. Leave empty to auto select.',
      healthProbeSyncModelsSuccess: 'Models synced successfully',
      healthProbeSyncModelsFailed: 'Failed to sync models',
      probeIntervalCustom: 'Probe interval (minutes)',
      probeIntervalPlaceholder: 'e.g. 1, 5, 10',
      probeIntervalInvalid: 'Probe interval must be greater than 0',
      ...
      healthEventsEmpty: 'No probe events',
      healthEventsLoadFailed: 'Failed to load probe events',
      eventColumns: {
        time: 'Time',
        type: 'Type',
        source: 'Source',

export default {
    accounts: {
      ...
      cnProviders: {
        ...
        skipBalanceCheck: {
          title: 'Skip automatic balance checks',
          hint: 'Use only for third-party gateways that do not implement the official DeepSeek balance endpoint. Real insufficient-balance responses still trigger a temporary cooldown.',
        },
        balance: 'Balance --',
      ...
      healthOverviewFailed: 'Failed to load health overview',
      healthOverviewPanel: {
        refresh: 'Refresh Overview',
        generatedAt: 'Updated {time}',
        notUpdated: 'Health data has not been loaded',
        overallStatus: 'Overall Status',
        statusCritical: 'Action Required',
        statusAttention: 'Needs Attention',
        statusGood: 'Healthy',
        riskCount: '{count} risk types',
        upstreams: 'Upstreams',
        abnormalCount: '{count} abnormal',
        accounts: 'Accounts',
        total: 'total',
        schedulable: 'Effectively Schedulable',
        isolatedDegraded: 'Isolated / Degraded',
        affectedGroups: 'Affected Groups',
        needsCoverage: 'need coverage',
        keyRisks: 'Key Risks',
        risksMergedHint: 'Risks of the same type are deduplicated by upstream, account, and group, with scheduling impact shown first.',
        levelCritical: 'Critical',
        levelWarning: 'Warning',
        levelInfo: 'Info',
        locate: 'Locate',
        affectedAccounts: '{count} accounts affected',
        showAbnormal: 'Abnormal {count}',
        showAll: 'All Upstreams {count}',
        allStates: 'All States',
        anomalyFirst: 'Anomalies first',
        searchPlaceholder: 'Search upstream, account, key, or group',
        expand: 'Expand upstream accounts',
        collapse: 'Collapse upstream accounts',
        upstreamHealthy: 'No scheduling risk detected for this upstream',
        noMatches: 'No upstreams or accounts match the current filters',
        riskAggregated: {
          urlAllUnavailable: '{count} upstreams have no available accounts',
          groupNoneAvailable: '{count} groups have no available accounts',
          groupSingleAvailable: '{count} groups have only one available account',
          consecutiveFailures: '{count} accounts have consecutive failures',
          probeDisabled: '{count} accounts have healthy checks disabled'
        }
      },
      riskSummary: 'Risk Summary',
      healthAccountCount: '{count} accounts',
      healthInsufficientGroups: 'Insufficient available accounts in groups: {groups}',
      healthDetail: 'Account Health Detail',
      healthDetailLoadFailed: 'Failed to load account health detail',
      ...
      probeSettingsHint: 'Control recovery probes and low-frequency checks for healthy accounts.',
      healthProbe: 'Manual Probe',
      probeEnabled: 'Enable Auto Recovery Probe',
      recoveryPriority: 'Recovery Probe Interval',
      recoveryPriorityDefault: 'Default',
      recoveryPriorityFast: 'Fast (3 min)',
      recoveryPriorityStandard: 'Standard (5 min)',
      recoveryPriorityConservative: 'Conservative (10 min)',
      healthProbeModel: 'Probe Model',
      healthProbeModelAuto: 'Auto Select',
      healthProbeSyncModels: 'Sync Models',
      healthProbeModelHint: 'Model used for health probing. Leave empty to auto select.',
      healthProbeSyncModelsSuccess: 'Models synced successfully',
      healthProbeSyncModelsFailed: 'Failed to sync models',
      probeIntervalCustom: 'Recovery probe interval (minutes)',
      probeIntervalPlaceholder: 'e.g. 1, 5, 10',
      healthyProbeEnabled: 'Enable Low-frequency Healthy Checks',
      healthyProbeHint: 'Healthy accounts are probed on this interval to refresh latency and health status.',
      healthyProbeInterval: 'Healthy Check Interval',
      healthyProbeIntervalHint: '1 minute greatly increases upstream probe traffic. Use it for tests or a few critical accounts only.',
      healthyProbeIntervalOptionHours: '{hours} h',
      healthyProbeIntervalOptionMinutes: '{minutes} min',
      probeIntervalInvalid: 'Recovery probe interval must be greater than 0',
      healthyProbeIntervalInvalid: 'Healthy check interval must be greater than 0',
      probeSettingsSaved: 'Probe settings saved',
      probeSettingsSaveFailed: 'Failed to save probe settings',
      healthProbeSuccess: 'Probe succeeded',
      healthProbeFailed: 'Probe failed',
      healthEvents: 'Health Events',
      healthEventsHint: 'View account health changes and probe history.',
      healthEventAll: 'All Events',
      healthEventsEmpty: 'No health events',
      healthEventsLoadFailed: 'Failed to load health events',
      eventColumns: {
        time: 'Time',
        type: 'Type',
        source: 'Source',
      ...
      upstreamBalanceRefresh: 'Refresh Balance',
      upstreamBalanceRefreshSuccess: 'Balance refreshed',
      upstreamBalanceRefreshFailed: 'Failed to refresh balance',
      upstreamBalanceUnitUpstream: 'Upstream balance {value}',
      upstreamBalanceEmpty: 'Not queried',
      upstreamBalanceChecking: 'Checking',
      upstreamBalanceValue: 'Balance {value}',
      upstreamBalanceAuthError: 'Auth failed',
      upstreamBalanceError: 'Query failed',
      upstreamBalanceUnsupported: 'Balance unavailable',
      upstreamBalanceRepresentative: 'Representative account ID: {id}',
      upstreamBalanceCheckedAt: 'Checked at: {time}',
      upstreamBalanceEndpoint: 'Endpoint: {endpoint}',
      upstreamBalanceUnitHint: 'Unit follows the upstream site display settings',
      upstreamBalanceHTTPStatus: 'HTTP status: {status}',
      riskGroupNoAvailable: 'No available accounts in group: {group}',
      riskGroupSingleAvailable: 'Only one available account in group: {group}',
      riskUrlAllIsolated: '{count} accounts on this upstream are all isolated',
      riskConsecutiveFailures: 'Account {account} failed {count} times consecutively',
      riskHealthyProbeDisabled: 'Healthy check is disabled for account {account}',
      healthStatus: {
        healthy: 'Healthy',
        degraded: 'Degraded',
        isolated: 'Isolated',
      ...
      upstreamBilling: {
        ...
        rechargeRatio: 'Upstream recharge ratio',
        rechargeRatioHint: 'Enter 10 when 1 unit of local currency buys 10 units of upstream balance. The local rate is the declared rate divided by this ratio.',
        invalidRechargeRatio: 'The upstream recharge ratio must be greater than zero; up to 4 decimal places are stored.',
        ...
        declaredRate: 'Upstream declared rate: {value}x',
        convertedRate: 'Local converted rate: {value}x',
        rechargeRatioValue: 'Upstream recharge ratio: 1:{value}',

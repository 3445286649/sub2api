export default {
    ...
    channelMonitor: {
      ...
      advanced: {
        ...
        responseMode: 'Responses transport',
        responseModeJSON: 'JSON response',
        responseModeSSE: 'Streaming SSE',
        responseModeHint: 'Match this monitor to its real upstream protocol; streaming mode parses Responses SSE deltas and terminal events.',
        bodyModeOff: 'Default',
        bodyModeMerge: 'Merge',
        bodyModeReplace: 'Replace',
        bodyModeHintOff: 'Use the adapter default body (includes challenge validation).',
        bodyModeHintMerge: 'Shallow-merge with the default body; user fields win but model / messages / instructions / input / contents are protected (use Replace to change those).',

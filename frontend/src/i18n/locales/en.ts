export default {
  ...
  nav: {
    ...
    acquisitionManagement: 'Acquisition Campaigns',
  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamBalanceUnitUpstream: '{value} upstream credits',
      upstreamBalanceEmpty: 'Not checked',
      upstreamBalanceChecking: 'Checking',
      upstreamBalanceUnsupported: 'Unavailable',
      upstreamBalanceError: 'Check failed',
      upstreamBalanceAuthError: 'Auth failed',
      upstreamBalanceRefresh: 'Refresh upstream balance',
      upstreamBalanceRefreshSuccess: 'Upstream balance refreshed',
      upstreamBalanceRefreshFailed: 'Failed to refresh upstream balance',
      upstreamBalanceRepresentative: 'Representative account #{id}',
      upstreamBalanceCheckedAt: 'Checked at: {time}',
      upstreamBalanceEndpoint: 'Endpoint: {endpoint}',
      upstreamBalanceUnitHint: 'new-api compatible endpoints use the upstream site display unit.',
      upstreamBalanceHTTPStatus: 'HTTP status: {status}',
      healthInsufficientGroups: 'Insufficient available accounts: {groups}',
      riskSummary: 'Risk Summary',
      riskGroupNoAvailable: 'Group {group} has no available accounts',
      riskGroupSingleAvailable: 'Group {group} has only 1 available account',
      riskUrlAllIsolated: 'All {count} accounts under this URL are unavailable',
      riskConsecutiveFailures: 'Account {account} failed {count} times in a row',
      riskHealthyProbeDisabled: 'Account {account} has healthy probe disabled',
      healthDetail: 'Account Health',
      healthScore: 'Health',
      ...
      boundGroups: 'Bound local groups',
      ...
      healthDetailLoadFailed: 'Failed to load health details',
      healthProbeSuccess: 'Health probe completed',
      healthProbeFailed: 'Health probe failed',
      probeSettings: 'Probe Settings',
      probeSettingsHint: 'When disabled, background probes will not auto recover this account. Manual health probe still works. Leave interval empty or 0 to use default backoff. Healthy checks send real upstream requests and may incur cost.',
      probeEnabled: 'Background probe',
      probeInterval: 'Probe interval (minutes)',
      probeIntervalCustom: 'Custom interval (minutes)',
      probeIntervalPlaceholder: 'Default backoff',
      probeIntervalInvalid: 'Probe interval must be 0 or a positive integer minute value',
      healthProbeModel: 'Probe model',
      healthProbeModelAuto: 'Automatic default model',
      healthProbeModelHint: 'Leave empty to use the platform default test model. For custom upstreams, choose a known working model.',
      healthProbeSyncModels: 'Sync upstream models',
      healthProbeSyncModelsSuccess: 'Upstream models synced',
      healthProbeSyncModelsFailed: 'Failed to sync upstream models',
      recoveryPriority: 'Recovery Priority',
      recoveryPriorityDefault: 'Default backoff',
      recoveryPriorityFast: 'Fast 3 minutes',
      recoveryPriorityStandard: 'Standard 5 minutes',
      recoveryPriorityConservative: 'Conservative 10 minutes',
      healthyProbeEnabled: 'Low-frequency probe for healthy accounts',
      healthyProbeHint: 'Off by default. Only schedulable accounts are checked; failures enter the score, degraded, and fast recovery flow.',
      healthyProbeInterval: 'Check interval',
      healthyProbeIntervalOption: '{hours} hours',
      healthyProbeIntervalOptionMinutes: '{minutes} minutes',
      healthyProbeIntervalOptionHours: '{hours} hours',
      healthyProbeIntervalHint: 'A 1-minute interval can significantly increase upstream probe traffic. Use it for testing or a small set of critical accounts.',
      healthyProbeIntervalInvalid: 'Healthy check interval must be a positive integer minute value',
      ...
      healthEvents: 'Health Event Stream',
      healthEventsHint: 'Shows score changes, isolation, recovery, manual probes, background probes, and settings changes.',
      healthEventsEmpty: 'No health events yet',
      ...
      columns: {
        ...
        notes: 'Notes',
        priority: 'Priority',
        billingRateMultiplier: 'Upstream Cost Rate',
        weight: 'Weight',
        status: 'Status',
        schedulable: 'Schedulable',
        health: 'Health',

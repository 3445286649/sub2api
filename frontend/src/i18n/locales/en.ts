  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        supportGroup: {
          title: 'Support Group',
          description: 'Show a support group entry in the header. Users can open a QR code card from it.',
          ...
          qrCodeUrlHint: 'Requires a full http(s) image URL when enabled. Empty URL hides the entry.',

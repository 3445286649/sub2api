export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_cnyPerUsdt: 'CNY/USDT rate',
        ...
        field_usdtCnyPerUsdtHint: 'Converts the CNY order amount into USDT. This means how many CNY 1 USDT is worth. Use a real rate such as 7.2; do not use 1 unless you intentionally test 1 CNY = 1 USDT.',
  ...
  payment: {
    ...
    crypto: {
      ...
      feeWarning: 'Wallet gas fees or exchange withdrawal fees are paid by the user. Please make sure the USDT actually received at the address exactly matches the amount above after fees, otherwise it will not be credited automatically and requires manual review.',

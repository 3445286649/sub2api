  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_usdtRateApiUrlHint: 'Price endpoint used in auto mode. Default is CoinGecko simple price with ids=tether&vs_currencies=cny. The endpoint must return JSON.',
        field_usdtRateJSONPathHint: 'Dot path used to read the rate from the JSON response. Default tether.cny matches {"tether":{"cny":7.2}}.',

export default {
    accounts: {
      ...
      probeDetail: '账号探活详情',
      probeDetailLoadFailed: '加载账号探活详情失败',
      probeNoData: '暂无数据',
      probeNormal: '正常',
      probeAbnormal: '异常',
      probeSuccessRate: '成功率',
      probeLastResult: '最近结果',
      probeLatencyTrend: '探活延迟趋势',
      probeFailures: '失败次数',
      nextProbe: '下次探活',
      probeEvents: '探活记录',
      probeEvents24h: '最近 24 小时探活记录',
      cacheRateOneHour: '最近 1 小时缓存率',
      cacheRateSample: '{count} 次请求',
      lastError: '最近错误',
      probeSettings: '探活设置',

...
export default {
  ...
  "usageRebate": {
    ...
    "currentLeader": "当前领先",
    "gapToPrevious": "与上一名的消费差额",
    "gapToTop20": "距第 20 名相差 {amount}",
    "top20Hint": "进入前 20 名后可获得返利",
    "leadingHint": "你当前排名第一，继续保持即可获得最高返利比例",
    "eligibleHint": "你已进入前 20 名，预计返利将在次日结算后入账",
    "reward": "返利金额",
    "status": "状态",
    "date": "日期",
    "myRewards": "我的返利记录",

export default {
  ...
  points: {
    ...
    debt: '积分欠账',
    inviteRule: '有效邀请奖励',
    inviteRuleValue: '新用户累计充值 {amount}，奖励 {points} 积分',
    balanceReward: '到账余额',
    remainingStock: '剩余库存',
    perUserLimit: '每人限兑',
    noProducts: '暂无已上架商品',
    ...
    insufficient: '积分不足',
    confirmTitle: '确认兑换',
    confirmMessage: '消耗 {points} 积分兑换“{name}”，到账余额 ${balance}。',
    redeemSuccess: '兑换成功，已到账 ${balance}',
    adminTitle: '积分商城',
    products: '商品管理',
    orders: '兑换记录',
    rules: '积分规则',
    ...
    description: '商品描述',
    pointsPrice: '所需积分',
    originalPointsPrice: '原积分',
    stockTotal: '总库存',
    unlimitedStock: '留空表示不限量',
    features: '功能特性',
    sortOrder: '排序',
    forSale: '上架状态',
    enabled: '启用积分商城',
    ...
    freezeHours: '冻结期（小时）',
    saveRules: '保存规则',
    deleteConfirm: '确定删除该商品吗？已有兑换记录的商品只能下架。',
    orderNo: '订单编号',
    user: '用户',
    time: '时间',
  },

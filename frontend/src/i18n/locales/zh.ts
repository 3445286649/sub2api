  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_usdtRateApiUrlHint: '自动模式使用的价格接口。默认 CoinGecko simple price：ids=tether&vs_currencies=cny。接口必须返回 JSON。',
        field_usdtRateJSONPathHint: '从价格接口 JSON 中取汇率的点号路径。默认 tether.cny，对应 {"tether":{"cny":7.2}}。',

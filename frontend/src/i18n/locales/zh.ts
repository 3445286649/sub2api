export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_usdtCnyPerUsdtHint: '用于把人民币订单金额换算为应付 USDT，含义是 1 USDT ≈ 多少 CNY。建议按实际汇率填写，例如 7.2；不要填 1，除非你明确要按 1 CNY = 1 USDT 测试。',
  ...
  payment: {
    ...
    crypto: {
      ...
      feeWarning: '钱包矿工费或交易所提币手续费由用户侧承担。请确保扣除手续费后，实际到达收款地址的 USDT 数量与上方应付数量完全一致，否则系统不会自动到账，需要人工处理。',
